...
def main():
    ...
    if args.model_dir != '':
        ...
        name = 'learned_prior-rnn_size=%d-predictor-posterior-rnn_layers=%d-%d-n_past=%d-n_future=%d-lr=%.4f-g_dim=%d-z_dim=%d-last_frame_skip=%s-beta=%.7f-anneal_cycle=%d-anneal_ratio=%.2f-tfr_decay_step=%.3f'\
